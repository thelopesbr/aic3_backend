...
exports.post = async function (playerOne, playerTwo, category, restriction, tournament, state, terms){
    return await database.one('INSERT INTO public.subscribe ("playerOne", "playerTwo", category, restriction, tournament, state, terms) VALUES ($1, $2, $3, $4, $5, $6, $7) returning * ', [playerOne, playerTwo, category, restriction, tournament, state, terms])
}
